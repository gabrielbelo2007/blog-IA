...
> **Observação**: É recomendado que as bibliotecas instaladas nos projetos em Python, sejam feitas nos ambientes virtuais, para criar o ambiente antes de executar o `pip install`, faça `python -m venv <nome_do_ambiente>`.

> Com o ambiente criado ative no **Windows**: `.\nome_do_ambiente\Scripts\activate.bat` ou no **Linux/macOS**: `source <nome_do_ambiente>/bin/activate`.
