...
> Isso acontece por conta da função *thinking* que por padrão vem ativada nos modelos do *Gemini*, está sendo implementado na biblioteca da da `google-generativeai` um controle dessa função para alguns modelos como o `2.5-flash`.
